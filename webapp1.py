...
def plot_graphs(dumper_id):
    ...
    # Create a DataFrame for each plot type (Pressure, Temperature, Speed)
    pressure_df = pd.DataFrame({
        "Time": time_data,
        "Front Left": front_left_pressure,
        "Front Right": front_right_pressure,
        "Rear Left": rear_left_pressure,
        "Rear Right": rear_right_pressure
    })

    temperature_df = pd.DataFrame({
        "Time": time_data,
        "Front Left": front_left_temperature,
        "Front Right": front_right_temperature,
        "Rear Left": rear_left_temperature,
        "Rear Right": rear_right_temperature
    })
    ...
    # Plot Pressure
    st.subheader("Tyre Pressure Over Time")
    pressure_fig = px.line(
        pressure_df,
        x="Time",
        y=["Front Left", "Front Right", "Rear Left", "Rear Right"],
        labels={"value": "Pressure (PSI)", "variable": "Tyre"},
        title="Tyre Pressure"
    )
    st.plotly_chart(pressure_fig)

    # Plot Temperature
    st.subheader("Tyre Temperature Over Time")
    temperature_fig = px.line(
        temperature_df,
        x="Time",
        y=["Front Left", "Front Right", "Rear Left", "Rear Right"],
        labels={"value": "Temperature (°F)", "variable": "Tyre"},
